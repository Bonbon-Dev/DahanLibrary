...
typedef NS_ENUM(NSUInteger, DHPresentationDirection){
    DHPresentationDirectionBottom = 0,  //底部  present默认效果
    DHPresentationDirectionRight,       //右边  导航栏效果
    DHPresentationDirectionTop,         //上面
    DHPresentationDirectionLeft,        //左边
};

@interface CmccUIModel : NSObject
/**
 版本注意事项:
...
@property (nonatomic, assign) DHPresentationDirection presentType;
/**4、授权界面背景图片*/
